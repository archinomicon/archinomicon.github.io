...
description: MAF Architecture Repository 
---
...
Требования используются во многих процессах организации. Как правило, реализуются в специализированных системах типа корпоративных Wiki - Confluence, EvaWiki, etc.
репозиторий должен как минимум обеспечить интеграцию с такими системами - на уровне веб-ссылок или другим способом.

Если в организации отсутствует системы управления требованиями, то возможна простая реализация такой системы в рамках архитектурного репозитория.
Например, можно использовать механизм Markdown с версионированием.


## Разрабатываем репозиторий
Получившийся репозиторий можно найти в [Minimal EA Repo](https://archinomicon.github.io/ea-repo/)