---
title: 1. Minimal Architecture Framework
...
В данной работе сделана попытка описать "минимально-жизнеспособный" набор практик Корпоративной архитектуры, подходящий для использования в организации любого масштаба. 
